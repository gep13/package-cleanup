...
namespace chocolatey.package.cleanup.host
{
    ...
    using cleanup.infrastructure.app;
    using cleanup.infrastructure.app.messaging;
    using cleanup.infrastructure.app.registration;
    using cleanup.infrastructure.filesystem;
    using cleanup.infrastructure.messaging;
