...
namespace chocolatey.package.cleanup.infrastructure.app.registration
{
    using System;
    using System.Net;
...
Prefer to use TLS v1.2 if it is available, but this client is 
 ...
 For more information you should visit https://www.howsmyssl.com/");
            ...
            try
            {
                ...
                {
                    "chocolatey".Log().Warn("ServerCertificateValidationCallback was set to '{0}' Removing.".format_with(ServicePointManager.ServerCertificateValidationCallback));
